...
def test_get_registration_invalid_format_firstname(browser, firstname):
    """Негативные сценарии регистрации на сайте, некорректный формат имени"""
...
def test_get_registration_invalid_format_lastname(browser, lastname):
    """Негативные сценарии регистрации на сайте, некорректный формат фамилии"""
    алид
...
def test_get_registration_invalid_format_phone(browser, phone):
    """Негативные сценарии регистрации на сайте, некорректный формат номера телефона"""
...
def test_get_registration_invalid_format_email(browser, email):
    """Негативные сценарии регистрации на сайте, некорректный формат почты"""
